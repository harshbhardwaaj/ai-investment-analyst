  ...
  return (
      <main className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="mb-10">
            <h1 className="text-3xl font-bold text-gray-900">AI Investment Analyst</h1>
          ...
          {loading && (
              <div className="text-center py-20 text-gray-400 text-sm">
                Generating memo for {DEMO_TICKER}...
              </div>
          )}

          {memo && !loading && (
              <div>
                <div className="border-b border-gray-100 mb-8 pb-2 flex items-center justify-between">
